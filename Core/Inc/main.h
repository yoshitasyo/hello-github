...
#define PWMC6_Pin GPIO_PIN_6
#define PWMC6_GPIO_Port GPIOC
#define PWMC7_Pin GPIO_PIN_7
#define PWMC7_GPIO_Port GPIOC
#define PWMA8_Pin GPIO_PIN_8
#define PWMA8_GPIO_Port GPIOA
#define PWMA11_Pin GPIO_PIN_11
#define PWMA11_GPIO_Port GPIOA
...
#define encoder3_2_GPIO_Port GPIOB
#define encoder3_1_Pin GPIO_PIN_7
#define encoder3_1_GPIO_Port GPIOB
